...
public class WeaponSlotManager : MonoBehaviour
{
    ...
    public void LoadWeaponOnSlot(WeaponItems weaponItems,bool isLeft)//讀取武器
    {//左邊右邊由PlayerInventory來決定
        ...
        else
        {
            ...
            LoadRightWeapinDamageCollider();//讀取collider
        }
    }
...
#region 跟collider有關的，左手部分還沒弄
    ...
    public void OpenRightHandDamageCollider()//再打開Collider的功能
    {
